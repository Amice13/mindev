    ...
    <v-card color="main">
      ...
      <v-card-text>
        ...
        >
          ...
          <template #item.1>
            <v-card class="bg-transparent" flat title="Сформувати документ">
              <v-card-text>
                <div class="mb-6">Для формування акту комісійного обстеження засобами системи натисніть "Сформувати", завантажте сформований документ та натисніть "Продовжити" для завантаження фотоматеріалів, його підписання та надання відомостей (даних) щодо об'єкту нерухомого майна, що було обстежено.</div>
                <v-btn color="primary-darken-1" @click="downloadDocument">Сформувати</v-btn>
              </v-card-text>
            </v-card>
          </template>
          ...
          <template #item.2>
            <v-card class="bg-transparent" flat title="Підписання документу">
              <v-card-text>
                <div class="mb-6">«Для підписання сформованого документу натисніть "Підписати" та скористайтесь сервісом "Дія.Підпис", а потім - натисніть "Продовжити".</div>
                <div class="mb-6">Звертаємо увагу, що на Акт має бути накладено кваліфікований електронний підпис саме з боку Голови комісії.</div>
                <div class="mb-6">У разі якщо акт було сформовано іншою особою - надішліть, будь ласка, сформований акт голові комісії для його підписання та подальшого завантаження до системи. До цього моменту ви можете скасувати процедуру, зберегти акт та повернутися до завантаження пізніше.</div>
                <div class="mb-6"><strong>УВАГА!</strong> У разі відсутності накладеного електронного підпису на сформований засобами системи акт Головою комісії акт прийнято не буде.</div>
